	var cssSlidyConvenios = function(newOptions) {
    var options = (function() {
        var mergedOptions = {},
        defaultOptions = {
            timeOnSlide: 3,
            timeBetweenSlides: 1.5,
            slidyContainerSelector: '#slidy-container-convenios', // name of slider container
            slidySelector: '#slidy-convenios', // name of slider
